...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _authenticateWithBiometrics() async {
    ...
    try {
      ...
      if (authenticated) {
        _userNameController.text = SPref.instance.get(Constants.USER_NAME);
        _passwordController.text = SPref.instance.get(Constants.PASSWORD);
  ...
  Future<void> checkLogin(String userName, String password) async {
    if (userName.isNotEmpty && password.isNotEmpty) {
      _userName = SPref.instance.set(Constants.USER_NAME, userName);
      _password = SPref.instance.set(Constants.PASSWORD, password);
      Navigator.pushNamed(context, HomePage.routeName,
          arguments: ScreenArguments(arg1: userName, arg2: password))
          .then((value) {
        setState(() {
          _checkShowFaceID = true;
          _userName = SPref.instance.get(Constants.USER_NAME);
          _password = SPref.instance.get(Constants.PASSWORD);
        });
